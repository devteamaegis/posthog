...
import { IconArrowLeft, IconCheck, IconChevronRight, IconClock, IconCopy, IconFlask } from '@posthog/icons'
...
export function UserInterview({ id }: UserInterviewLogicProps): JSX.Element {
    ...
    const { loadTestLink } = useActions(userInterviewLogic)
