...
async def arun_signals_scout(
    *,
    ...
    # Best-effort — there is a TOCTOU window between this check and the bridge-row
    # insert inside _spawn_and_run; we accept that until a claim/lease primitive lands.
