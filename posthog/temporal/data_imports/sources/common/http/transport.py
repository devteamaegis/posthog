...
def make_tracked_session(
    *,
    ...
    # proxies via a separate pool manager, which bypasses the post-connect
    # peer check. `trust_env=False` makes "no proxy" a guarantee, not an
    # assumption about how workers happen to be configured.
